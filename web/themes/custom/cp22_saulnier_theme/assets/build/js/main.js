  ...
  var Header = /*#__PURE__*/function () {
    ...
    _createClass$1(Header, [{
      ...
      function init() {
        ...
        var btnBurger = document.querySelector('.Header-hamburger');
        var main_menu = document.querySelector('.Header-mobileMenu');
        var btnLienMenu = document.querySelector('.btn-liens-menu');
        var mainMenuSecondOpen = document.querySelector('.Header-menuMain-secondLevel');
        ...
        this.$MainMenuFirstLevelLinks = $$1('.Header-menuMain-firstLevel > .Header-menuMain-itemList'); // declaration du body pour etre à l'ecoute des evenement sur toute la page

        this.$body = $$1('body'); // this.$header = $('.Header');
      ...
      value: function manageClickOnFirstLevelMainMenuLinks(event) {
        var $currentTarget = $$1(event.currentTarget);
